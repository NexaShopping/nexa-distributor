          ...
          {order.payment ? (
            <>
              <div className="mt-1 flex items-center justify-between gap-3">
                <p className="text-xs text-ink-soft">{order.payment.purpose === "DISTRIBUTOR_ORDER" ? "PhonePe" : order.payment.purpose}</p>
            ...
            <p className="mt-2 text-sm text-ink-soft">No payment attempt was recorded for this order.</p>
          )}
        </Card>
      }
