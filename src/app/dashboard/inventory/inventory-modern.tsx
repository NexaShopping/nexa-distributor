...
export default function InventoryModern() {
  ...
  const visible = useMemo(() => {
    ...
    return [...filtered].sort((a, b) => sort === "high" ? b.available - a.available : sort === "new" ? new Date(b.updatedAt).getTime() - new Date(a.updatedAt).getTime() : a.available - b.available);
  }, [items, lowOnly, sort]);
