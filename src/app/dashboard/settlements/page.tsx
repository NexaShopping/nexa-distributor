...
import { SettlementsModern } from "@/features/settlements/settlements-modern";

function LegacySettlementsPage() {
  ...
  return <div className="settlements-page mx-auto max-w-5xl space-y-6">
    <nav className="settlements-heading flex items-center gap-2 text-sm text-ink-soft">
      <Link href="/dashboard" className="hover:text-ink">Dashboard</Link><span>›</span><strong className="font-medium text-ink">Payouts</strong>
    </nav>
